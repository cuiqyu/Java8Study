...
import com.limpid.inner.CarFactory;
import com.limpid.inner.FourWheeler;
import com.limpid.inner.Vehicle;
 ...
 */
public class Feature4DefaultMethod {
    ...
    public static void main(String[] args) {
        Vehicle vehicle = () -> {System.out.println("重写的方法！");};
        vehicle.test();
        vehicle.print();
        Vehicle.blowHorn();

        FourWheeler fourWheeler = () -> {System.out.println("重写的方法！");};
        fourWheeler.test();
        fourWheeler.print();
